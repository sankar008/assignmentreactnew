...
import { IMG, TIMEZONE } from "../Api/constant";
const Messagefedd = ({
  setText,
  text,
  userDetails,
  ...
  return (
    <>
      <div className="headerTitle">
        <h4>Product name : {userDetails[0].productName}</h4>
        <h4>Product details : {userDetails[0].product_des}</h4>
                          ...
                          {item.image[0] === "" ? (
                            ...
                            <>
                              {item.image[0].type === "image" ? (
                                <img src={IMG + item.image[0].file} />
                              ) : (
                                <a
                                  className="aplicationTyp"
                                  href={IMG + item.image[0].file}
                                  target="_blank"
                                >
                        ...
                        {item.message[0].btn === "accept" ? (
                          <>
                            <div class="comandBtn">
                              <span
                                class="buttonS"
                                onClick={() => messageAccept()}
                              >
                                Accept
                              </span>
                              <span
                                class="buttonSr"
                                onClick={() => regectMessage()}
                              >
                                Reject
                              </span>
                            </div>
