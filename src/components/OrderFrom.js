            ...
            <div className="row mt-3 ">
              <div className="col-md-12">
                <div class="form-group border_textArea">
                  <textarea name="" id="" cols="30" rows="2" placeholder="Text here"></textarea>
                  <div class="form-group up_load">
                  <input className="choose_option"
                    type="file"
                    name="email"
                    value=""
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#777777" class="bi bi-file-earmark-pdf" viewBox="0 0 16 16">
