        ...
        <div className="container">
          {location?.state?.data === 1 ? (
            <>
              ...
              <div
                className={`row justify-content-center  ${
                  showSignUpSection3 === false ? "hide" : "block"
                }`}
              >
                <div className="col-lg-12">
                  <div className="order_header"></div>
              ...
              <div
                className={`row items-center justify-content-center mt-5 ${finalOrderPage}`}
              >
                <div className="col-lg-6" id="paymentpt1">
                  <div className="sort_tbl">
                    ...
                    <div className="face_img_txt">
                      ...
                      <span>
                        <strong>575 Tutors</strong> Avilable for{" "}
                        {subjectData?.label}
                      </span>
                    </div>
                  </div>
            ...
            <>
              ...
              <div
                className={`row justify-content-center  ${
                  showSignUpSection4 === false ? "hide" : "block"
                }`}
              >
                <div className="col-lg-12">
                  <div className="order_header"></div>
              ...
              >
                <div className="step_buttn">
                  <button
                    className="continue_btn"
                    onClick={setionthreeDateandTime}
                  >
                    Continue
                  </button>
                </div>
